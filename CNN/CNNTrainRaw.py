...
DEF_FILE_MAX = 50  # 文件编号的最大值
DEF_MAX_TRIALS = 3  # 最大训练次数
# DEF_N_ROWS = 60                    #每个文件的最大行数
DEF_N_ROWS = 150
# DEF_COLUMNS = (0, 1, 2, 3, 4, 5)  # 从文件中读取的列索引
DEF_COLUMNS = (3, 4, 5)
# DEF_COLUMNS = (0, 1, 2)
...
def train(x_train, y_train, x_test, y_test, input_shape=(DEF_N_ROWS, 3), num_classes=len(motion_names),
    ...
    checkpoint = callbacks.ModelCheckpoint(DEF_MODEL_NAME, monitor='val_accuracy', save_best_only=True,
