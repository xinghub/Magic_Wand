...
/* Macros --------------------------------------------------------------------*/
// IIC1 Macros
#define IIC1_SDA(BitVal) HAL_GPIO_WritePin(GPIOB, IIC1_SDA_Pin, BitVal);
#define IIC1_SCL(BitVal) HAL_GPIO_WritePin(GPIOB, IIC1_SCL_Pin, BitVal);
#define IIC1_READ_SCL_PIN() HAL_GPIO_ReadPin(GPIOB, IIC1_SDA_Pin)

// IIC2 Macros
#define IIC2_SDA(BitVal) HAL_GPIO_WritePin(GPIOB, IIC1_SDA_Pin, (GPIO_PinState)BitVal);
#define IIC2_SCL(BitVal) HAL_GPIO_WritePin(GPIOB, IIC1_SCL_Pin, (GPIO_PinState)BitVal);
#define IIC2_READ_SCL_PIN() HAL_GPIO_ReadPin(GPIOB, IIC1_SCL_Pin)
